...
Generated by `python3 -m backtesting.run_momentum_breakout` into `backtesting/momentum_breakout_report.json`.

**Measured on Binance Vision 5m data, 2025-09-11 → 2026-09-10, 13 liquid USDT names, $10,000 start, 0.05% round-trip fee + 0.10% slip. Impulse grid frozen from IS; OOS is the last 1/3.**

**Verdict: REJECT.** Out-of-sample profit factor **0.027 < 1.2**. The bot does **not** sit on its hands (~125 trades/month after the halt fix), but 5-minute 20-bar volume breakouts on liquid names mean-revert. A true 3% 5m impulse is rare on this universe, so `{2.5, 3.0, 3.5}` all produced the same 871 IS trades.

| | Trades | Win % | PF | Avg R | Max DD % | Sharpe | Return % | Trades/mo | BTC hold % |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| In-sample (first 2/3) | 871 | 6.66 | 0.032 | −1.138 | 92.67 | −12.96 | −92.65 | 125 | −27.99 |
| Out-of-sample (last 1/3) | 506 | 4.15 | 0.027 | −1.294 | 78.45 | −12.73 | −78.40 | 127 | −5.17 |
| Full sample | 1361 | 5.80 | 0.032 | −1.191 | 98.31 | −12.75 | −98.30 | 124 | −31.71 |

OOS split by BTC vs 1h EMA 200: bull 253 trades, PF **0.009**; bear 253 trades, PF **0.039**. Both fail.

Do not data-mine extra knobs after seeing OOS. The spec allowed one impulse grid on IS only.
