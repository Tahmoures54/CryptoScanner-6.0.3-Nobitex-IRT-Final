...
class UIFactory:
    ...
    def _build_control_panel(self) -> None:
        ...
        _field_label(row1, "Source:")
        api_cb = ttk.Combobox(row1, textvariable=app.api_source_var,
                              values=["CoinGecko", "CoinMarketCap", "Binance"],
                              state="readonly", width=14)
        api_cb.pack(side="left", padx=(0, T.PAD_XL))
        api_cb.bind("<<ComboboxSelected>>", app.on_api_source_change)
